...
const Catalog = () => {
  ...
  useEffect(() => {
    const getCategories = async () => {
      ...
      const category_id = res?.data?.result?.filter(
  ...
  return (
    <>
      ...
      <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
        ...
        <div className="my-4 flex border-b border-b-richblack-600 text-sm">
          <p
            className={`px-4 py-2 ${
              active === 1
                ? "border-b border-b-lightblue-300 text-lightblue-300"
                : "text-richblack-50"
            } cursor-pointer`}
            onClick={() => setActive(1)}
          >
      ...
      <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
        ...
        <div className="py-8 text-richblack-25">
          <CourseSlider
      ...
      <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
        ...
        <div className="py-8">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 text-richblack-25">
